    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 12, 8, 21, 22, 42, 454, DateTimeKind.Local).AddTicks(6185), "eminakkurtt@icloud.com", true, true, "Test", "123456*", null, "User", new Guid("f7854c98-9bce-4e49-b365-7228a9cc9ddf"), "Admin" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreateData", "Description", "Image", "IsActive", "IsTopMenu", "Name", "OrderNo", "ParentId" },
                values: new object[,]
                {
                    { 1, new DateTime(2024, 12, 8, 21, 22, 42, 455, DateTimeKind.Local).AddTicks(8764), null, null, true, true, "Elektronik", 1, 0 },
                    { 2, new DateTime(2024, 12, 8, 21, 22, 42, 455, DateTimeKind.Local).AddTicks(9928), null, null, true, true, "Bilgisayar", 2, 0 }
                });
